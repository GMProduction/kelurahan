        ...
        <ul class="nav flex-column text-white w-100 h-100">
            ...
            <a href="/admin/warga">
                <li href="#" class="nav-link t-white">
                    ...
                    <span class="mx-2">Master Warga</span>
                </li>
            </a>
            ...
            <a href="/admin/syarat" >
                <li href="#" class="nav-link t-white">
                    ...
                    <span class="mx-2">Master Syarat</span>
                </li>
            </a>
            ...
            <a href="/admin/surat" >
                <li href="#" class="nav-link t-white">
                    ...
                    <span class="mx-2">Master Surat</span>
                </li>
            </a>

            <a href="/admin/pengurusan" >
                <li href="#" class="nav-link t-white">
                    <i class='bx bx-envelope' ></i>
                    <span class="mx-2">Pengurusan Surat</span>
                </li>
            </a>
